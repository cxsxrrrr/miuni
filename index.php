        ...
        <div class="grid w-full place-items-center md:place-items-stretch md:items-center gap-12 md:gap-14 md:grid-cols-2">
          ...
          <div id="heroContent" class="w-full max-w-xl space-y-8 text-white/90 text-center md:text-left mx-auto md:mx-0 overflow-visible">
            ...
            <div class="flex flex-col sm:flex-row items-center sm:items-end md:items-center gap-6 sm:gap-8">
              <a href="login.php" class="px-8 py-3 rounded-full bg-gradient-to-r from-[#3fb886] to-[#208765] text-white font-semibold shadow-xl hover:scale-105 transition-transform">Comenzar ahora</a>
